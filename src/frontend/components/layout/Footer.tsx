      ...
      <div className="container-site relative z-10 w-full pb-8 md:pb-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <nav className="flex flex-wrap justify-center md:justify-end gap-x-6 gap-y-2 text-[12px] uppercase tracking-widest">
            ...
            <Link href="/policies/shipping" className="hover:text-champagne-gold transition-colors">
              Shipping & Returns
            </Link>
            <Link href="/policies/privacy" className="hover:text-champagne-gold transition-colors">
              Privacy Policy
            </Link>
            <Link href="/faq" className="hover:text-champagne-gold transition-colors">
              FAQ
            </Link>
            <Link href="/contact" className="hover:text-champagne-gold transition-colors">
              Contact
            </Link>
          </nav>
        </div>
