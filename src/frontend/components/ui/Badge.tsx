...
export const Badge: React.FC<BadgeProps> = ({ children, className, variant = 'new', ...props }) => {
  const baseStyles =
    'inline-block text-[9px] uppercase tracking-[0.18em] px-2 py-1 font-medium select-none';
