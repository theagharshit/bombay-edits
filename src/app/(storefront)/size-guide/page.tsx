  ...
  return (
    <div className="container-site section-padding max-w-3xl mx-auto">
      ...
      <p className="text-sm text-text-muted mb-10">
        All measurements are in inches. If you are between sizes, we recommend sizing up for a
        relaxed fit or sizing down for a fitted look.
      </p>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-4 text-sm text-deep-brown leading-relaxed">
          <p>
            <strong className="text-ink">Bust:</strong> Measure around the fullest part of your
            bust, keeping the tape level.
          </p>
          <p>
            <strong className="text-ink">Waist:</strong> Measure around your natural waistline, the
            narrowest part of your torso.
          </p>
          <p>
            <strong className="text-ink">Hip:</strong> Measure around the fullest part of your hips,
            keeping the tape level.
          </p>
          <p>
            <strong className="text-ink">Shoulder:</strong> Measure from the edge of one shoulder to
            the other across the back.
          </p>
        </div>
      </div>
      ...
      <div className="bg-cream p-8 rounded-none">
        ...
        <p className="text-sm text-deep-brown leading-relaxed mb-4">
          ...
          measurements. This service is included for all made-to-order pieces. For ready-to-wear
          pieces, custom stitching is available for an additional fee.
        </p>
        <Link
          href="/contact"
          className="inline-block text-sm font-body text-ink border-b border-ink pb-0.5 hover:text-deep-brown hover:border-deep-brown transition-colors"
