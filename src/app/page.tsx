...
export default function HomePage() {
  return (
    <div className="bg-ivory text-cocoa font-body w-full flex-1 flex flex-col">
      ...
      {/* ─── 2. The Latest Edit ────────────────────────────── */}
      <SectionWrapper bgClass="bg-ivory" className="pt-[160px] pb-[120px]" style={{ paddingTop: '160px', paddingBottom: '120px' }}>
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-xl" style={{ marginBottom: '120px' }}>
          <div className="max-w-[420px]">
            <h2 className="font-display text-4xl md:text-[48px] text-espresso mb-0 leading-none">The Latest Edit</h2>
              ...
              >
                <Link href={`/shop/${product.slug}`} className="block">
                  ...
                  <div className="text-center mt-5">
                    <h3 className="font-display text-lg md:text-[20px] text-espresso mb-0">{product.name}</h3>
                    <p className="text-[13px] text-muted mt-1-5 mb-0">{product.descriptor}</p>
                    <span className="text-[13px] font-body text-cocoa block mt-2xs">{product.price}</span>
                  </div>
                </Link>
              </div>
            ))}
      ...
      <SectionWrapper bgClass="bg-cream">
        <div className="text-center mb-xl">
          <h2 className="font-display text-4xl md:text-[48px] text-espresso mb-0">Curated Collections</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-sm">
          ...
          <div className="relative aspect-[3/4] lg:aspect-auto lg:col-span-1 lg:row-span-2 min-h-[400px]">
            ...
            <div className="absolute bottom-lg left-lg right-lg z-10 flex flex-col items-start text-left">
              ...
              <Link href="/collections/bridal-edit" className="inline-block border border-white text-on-image px-6 py-2 text-[11px] tracking-[0.18em] uppercase hover:bg-white hover:text-espresso transition-colors rounded-none">
                Explore
              </Link>
            </div>
          </div>
          ...
          <div className="bg-sand p-lg flex flex-col items-center justify-center text-center lg:col-span-1 lg:row-span-1 min-h-[350px]">
            ...
            <Link href="/collections/festive-edit" className="inline-block border border-espresso text-espresso px-6 py-2 text-[11px] tracking-[0.18em] uppercase hover:bg-espresso hover:text-white transition-colors rounded-none">
              Discover
            </Link>
          </div>
          ...
          <div className="bg-sand p-lg flex flex-col items-center justify-center text-center lg:col-span-1 lg:row-span-1 min-h-[350px] order-last md:order-none lg:order-none">
            ...
            <Link href="/collections/evening-edit" className="inline-block border border-espresso text-espresso px-6 py-2 text-[11px] tracking-[0.18em] uppercase hover:bg-espresso hover:text-white transition-colors rounded-none">
              Discover
            </Link>
          </div>
      ...
      {/* ─── 4. Our Heritage ────────────────────────────────── */}
      <SectionWrapper bgClass="bg-ivory relative overflow-hidden" className="py-[120px]" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        {/* Subtle architectural watermark (3% opacity) */}
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: 'url(https://www.transparenttextures.com/patterns/arabesque.png)', backgroundSize: '400px' }}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg md:gap-20 items-center relative z-10">
          ...
          <div className="lg:col-span-5 order-1 lg:order-none" style={{ width: '100%' }}>
            ...
            <div className="p-4 border border-beige-line bg-ivory mx-auto lg:mx-0 lg:mt-8" style={{ maxWidth: '420px', width: '100%' }}>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center order-2 lg:order-none mt-lg lg:mt-0">
            <span className="text-[11px] tracking-[0.18em] uppercase text-muted mb-xs">Our Heritage</span>
            <h2 className="font-display text-[40px] lg:text-[48px] text-espresso mb-md leading-tight">
              Born from Bombay.<br />Edited by Anannya.
            </h2>
            <div className="flex flex-col gap-md text-[15px] text-cocoa leading-relaxed max-w-[500px]">
              <p>
                We draw our inspiration from the juxtaposition of the old world and the new. The fading grandeur of colonial architecture meets the vibrant, relentless pulse of modern India.
              </p>
              <p>
                Every garment is a narrative—handcrafted by master artisans, designed to transcend seasons, and tailored for the woman who carries her heritage with effortless grace.
              </p>
            </div>
            <Link
              href="/the-craft"
