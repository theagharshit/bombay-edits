...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      ...
      >
        <h1 className="font-display text-4xl mb-4" style={{ color: '#4A3025' }}>Your Archive is Empty</h1>
  ...
  return (
    <div className="font-body" style={{ backgroundColor: '#FAF6F0', color: '#4A3025' }}>
      ...
      <div 
        ...
        style={{ maxWidth: '1200px', margin: '0 auto', paddingTop: '160px', paddingBottom: '40px', marginBottom: '64px', borderBottom: '1px solid #E5DFD5' }}
      >
        <h1 className="font-display text-3xl md:text-4xl" style={{ color: '#4A3025' }}>The Heritage Selection</h1>
        <span className="text-[10px] uppercase tracking-[0.2em] mb-2 hidden md:block" style={{ color: '#8A817C' }}>
          {itemCount} {itemCount === 1 ? 'Artisanal Piece' : 'Artisanal Pieces'}
        </span>
      </div>

      <div className="px-6 md:px-12 lg:px-24" style={{ maxWidth: '1200px', margin: '0 auto', marginBottom: '128px' }}>
        <div className="flex flex-col lg:flex-row" style={{ gap: '64px' }}>
            ...
            <div className="space-y-12">
              {items.map((item) => (
                <div
                  ...
                  style={{ gap: '48px', paddingBottom: '64px', marginBottom: '64px', borderBottom: '1px solid #E5DFD5' }}
                >
                  {/* Image */}
                  <div className="w-full md:w-1/3 aspect-[4/5] relative p-2 shrink-0" style={{ border: '1px solid #E5DFD5', backgroundColor: '#FAF8F5' }}>
                  ...
                  <div className="w-full md:w-2/3 flex flex-col justify-between">
                    <div>
                      <span className="text-[10px] uppercase tracking-[0.2em] mb-2 block" style={{ color: '#8A817C' }}>
                        The Archives
                      </span>
                      <Link
                        href={`/shop/${item.slug}`}
                      ...
                      <div className="flex gap-4 mb-8">
                        <span className="text-[10px] uppercase tracking-[0.2em] px-3 py-1.5" style={{ border: '1px solid #E5DFD5', color: '#8A817C' }}>
                          Size: {item.size}
                        </span>
                        <span className="text-[10px] uppercase tracking-[0.2em] px-3 py-1.5" style={{ border: '1px solid #E5DFD5', color: '#8A817C' }}>
                          Color: {item.colour}
                    ...
                    <div className="flex items-end justify-between">
                      <div className="flex items-center gap-6">
                        <div className="flex items-center gap-4 text-xs font-body pb-1" style={{ borderBottom: '1px solid #E5DFD5', color: '#8A817C' }}>
                          <button
                            onClick={() =>
          ...
          <div className="lg:w-1/3 space-y-8 lg:sticky lg:self-start" style={{ top: '120px' }}>
            {/* Gift Dossier */}
            <div style={{ padding: '48px', border: '1px solid #E5DFD5', backgroundColor: '#FAF8F5' }}>
              <h2 className="font-display text-2xl mb-4 flex items-center gap-3" style={{ color: '#4A3025' }}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
              ...
              <label className="flex items-start gap-3 cursor-pointer group mb-4">
                <div className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ border: '1px solid #E5DFD5' }} />
                <div>
                  <p className="text-[10px] uppercase tracking-[0.1em] mb-1" style={{ color: '#4A3025' }}>
            ...
            {/* Summary */}
            <div style={{ padding: '48px', border: '1px solid #E5DFD5', backgroundColor: '#FAF8F5', marginTop: '32px' }}>
              <h2 className="font-display text-2xl mb-6" style={{ color: '#4A3025' }}>Summary</h2>
              <div className="space-y-4 text-xs font-body pb-6 mb-6" style={{ borderBottom: '1px solid #E5DFD5' }}>
              ...
              <div className="flex justify-between items-end mb-8">
                <span className="text-[10px] uppercase tracking-[0.2em]" style={{ color: '#8A817C' }}>
                  Total
                </span>
      ...
      {/* You May Also Like */}
      <div className="px-6 md:px-12 lg:px-24" style={{ maxWidth: '1200px', margin: '0 auto', paddingBottom: '128px', marginTop: '64px' }}>
        <div className="flex justify-between items-end" style={{ paddingBottom: '24px', marginBottom: '64px', borderBottom: '1px solid #E5DFD5' }}>
          <h2 className="font-display text-3xl" style={{ color: '#4A3025' }}>You May Also Like</h2>
          <Link
            href="/shop"
