  ...
  if (items.length === 0) {
    return (
      <div className="bg-ivory text-deep-brown font-body min-h-[60vh] flex flex-col items-center justify-center px-6 text-center">
        ...
        <Link
          href="/shop"
          className="inline-block bg-chocolate text-ivory px-12 py-4 text-[10px] uppercase tracking-[0.2em] hover:bg-deep-brown transition-colors"
        >
          Explore The Edit
        </Link>
      </div>
    ...
    <div className="bg-ivory text-deep-brown font-body">
            ...
            <div className="space-y-12">
              {items.map((item) => (
                <div
                  ...
                  className="flex flex-col md:flex-row gap-8 pb-12 border-b border-border"
                >
                  {/* Image */}
                  ...
                  <div className="w-full md:w-2/3 flex flex-col justify-between">
                    <div>
                      <span className="text-[10px] uppercase tracking-[0.2em] text-text-muted mb-2 block">
                        The Archives
                      </span>
                      <Link
                        href={`/shop/${item.slug}`}
                        className="font-display text-3xl text-chocolate hover:opacity-70 transition-opacity mb-4 block"
                      >
                        {item.name}
                      </Link>
                      ...
                      <div className="flex gap-4 mb-8">
                        <span className="text-[10px] uppercase tracking-[0.2em] border border-border px-3 py-1.5 text-text-muted">
                          Size: {item.size}
                        </span>
                        <span className="text-[10px] uppercase tracking-[0.2em] border border-border px-3 py-1.5 text-text-muted">
                          Color: {item.colour}
                    ...
                    <div className="flex items-end justify-between">
                      <div className="flex items-center gap-6">
                        ...
                        <button
                          ...
                          className="text-[10px] uppercase tracking-widest text-wine hover:opacity-70"
                        >
                          Remove
                        </button>
                      </div>
          ...
          <div className="lg:w-1/3 space-y-8 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="border border-border p-8 bg-[#FAF8F5]">
              ...
              <label className="flex items-start gap-3 cursor-pointer group mb-4">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-[0.1em] text-chocolate mb-1">
            ...
            <div className="border border-border p-8 bg-[#FAF8F5]">
              ...
              <Link
                href="/checkout"
                className="block w-full bg-chocolate text-ivory text-center py-4 text-[10px] uppercase tracking-[0.2em] hover:bg-deep-brown transition-colors"
              >
                Proceed to Checkout
              </Link>
            </div>
      ...
      <div className="px-6 md:px-12 lg:px-24 max-w-[1200px] mx-auto pb-32">
        <div className="flex justify-between items-end border-b border-border pb-4 mb-12">
          ...
          <Link
            href="/shop"
            className="text-[10px] uppercase tracking-[0.2em] text-text-muted hover:text-chocolate transition-colors hidden md:block"
          >
            Explore Archives
          </Link>
        </div>
