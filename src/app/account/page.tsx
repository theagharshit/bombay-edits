    ...
    <div className="bg-ivory text-deep-brown font-body">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12 lg:px-24 max-w-[1200px] mx-auto flex flex-col md:flex-row md:justify-between md:items-end border-b border-border">
        <div>
          ...
          <h1 className="font-display text-3xl md:text-4xl text-chocolate mb-2">
            Welcome back,
            <br />
            Madame Anya.
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-5/12">
            ...
            <ul className="space-y-6 mb-24 font-display text-2xl text-dark-espresso">
              ...
              <li>
                <Link href="/wishlist" className="hover:text-champagne-gold transition-colors">
                  Wishlist Archives
                </Link>
              </li>
              <li>
                <Link href="/the-craft" className="hover:text-champagne-gold transition-colors">
                  The Craft Atelier
                </Link>
              </li>
            </ul>
            ...
            <div className="mb-24">
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-muted-taupe mb-2">
                      Delivered: Oct 12
                    </p>
                    <p className="font-display text-lg text-dark-espresso mb-1">
                      The Malabar Silk Blouse
                    </p>
                    <p className="text-xs text-chocolate-brown font-body">
              ...
              <Link
                href="/account/orders"
                className="inline-block mt-12 bg-dark-espresso text-cream px-8 py-3 text-[10px] uppercase tracking-[0.2em] hover:bg-chocolate-brown transition-colors"
              >
                View Full Archive
              </Link>
            </div>
            ...
            <div>
              ...
              <Link
                href="/shop"
                className="block relative aspect-video w-full border border-beige-line group overflow-hidden cursor-pointer"
              >
                <Image
