  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto pb-32">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">The store operates in integer minor units. All prices are stored as paisa/cents, never floats.</p>
      </div>
            ...
            {SUPPORTED.map((c) => (
              <tr key={c.code} className="hover:bg-gray-50">
                ...
                <td className="py-3 px-5 text-center">
                  {c.primary ? (
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full text-[10px] font-semibold uppercase tracking-wider">Primary</span>
                  ) : (
                    <span className="px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full text-[10px] font-semibold uppercase tracking-wider">Supported</span>
                  )}
                </td>
              </tr>
            ))}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 text-sm text-blue-800">
        <strong>Note:</strong> Currency conversion rates are not managed here. All prices in the database are stored in their respective currency's minor units (e.g., NPR paisa, USD cents).
