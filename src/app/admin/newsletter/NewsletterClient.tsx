...
export function NewsletterClient({ data, meta, counts }: NewsletterClientProps) {
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <div className="flex bg-gray-100 rounded p-1">
          {[
            ...
            <button
              key={t.value}
              onClick={() => setParam('active', t.value)}
            ...
            {data.length === 0 ? (
              ...
              data.map((sub) => (
                <tr key={sub.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-500 hidden md:table-cell capitalize">
                    {sub.source}
                  </td>
                  ...
                  <td className="py-3 px-4 text-center">
                    <span
                      className={`px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wider ${sub.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}
                    >
