...
function SearchResults() {
  ...
  return (
    <div className="container-site section-padding">
      ...
      {query && <p className="text-sm text-text-muted mb-8">Showing results for &ldquo;{query}&rdquo;</p>}
      ...
      {!query ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-text-muted mb-6">Try a different search term or browse our collections.</p>
          <Link href="/shop" className="inline-block bg-ink text-ivory px-8 py-3 text-sm font-body rounded-sm">Browse all products</Link>
        </div>
      ) : (
